...
#define GxEPD2_DRIVER_CLASS GxEPD2_213     // GDE0213B1   128x250, IL3895, phased out     // <-- works with GDEM0213D23
...
//#define GxEPD2_DRIVER_CLASS GxEPD2_213_B74 // GDEM0213B74 128x250, SSD1680                  // <-- takes very long time to load and fails mostly
...
// With SD on Same BUS
// GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ 15, /*DC=*/ 13, /*RST=*/ 12, /*BUSY=*/ 14));
